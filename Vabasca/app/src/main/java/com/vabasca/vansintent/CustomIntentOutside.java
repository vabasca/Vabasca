package com.vabasca.vansintent;
...
import com.vabasca.bean.ShoppingList;
import com.vabasca.dao.ItemShoppingListDAO;
import com.vabasca.dao.ShoppingListDAO;
import com.vabasca.vansexception.VansException;
...
public class CustomIntentOutside {
	...
	public static void UpdateApp(Context context) {
		if (sucessInternetConnectivity(context, true)) {
			try {
				...
				context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com.vabasca/store/apps/details?id=" + context.getPackageName())));
			}
		}
	}
	...
	public static void barcodeScanner(Context context, int requestCode) {
		try {
			Intent intent = new Intent("com.vabasca.google.zxing.client.android.SCAN");
			// intent.setPackage("com.vabasca.google.zxing.client.android");
			intent.putExtra("SCAN_MODE", "PRODUCT_MODE"); // PRODUCT_MODE
			/*
			 * Intent intent = new
			 * Intent("com.vabasca.google.zxing.client.android.SCAN");
			 * intent.setPackage("com.vabasca.google.zxing.client.android");
			...
			if (sucessInternetConnectivity(context, true)) {
				Uri marketUri = Uri.parse("market://details?id=com.vabasca.google.zxing.client.android");
